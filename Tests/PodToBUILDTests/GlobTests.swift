...
class GlobTests: XCTestCase {
    ...
    func testInnerEitherPattern() {
        ...
        XCTAssertEqual(testPattern.sorted(by: (<)), ["Source/Classes/**/*.h", "Source/Masses/**/*.h"])
    }
    ...
    func testFBSdkCorePattern() {
        let testPattern = pattern(
            fromPattern: "FBSDKCoreKit/FBSDKCoreKit/Internal/AppLink/**/*",
            includingFileTypes: [".m"]
        )
    ...
    func testCurlysInMiddle() {
        let testPattern = pattern(fromPattern: "Source/{Classes,Glasses}/**/*.m", includingFileTypes: [".m"])
        XCTAssertEqual(testPattern.sorted(by: (<)), ["Source/Classes/**/*.m", "Source/Glasses/**/*.m"])
    }
