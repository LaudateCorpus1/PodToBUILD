public struct ModuleMap: BazelTarget {
    ...
    public init(
        ...
        moduleName: String,
        headers: [String],
        swiftHeader: String? = nil,
        moduleMapName: String? = nil,
    ...
    public func toSkylark() -> SkylarkNode {
        var args: [SkylarkFunctionArgument] = [
            .named(name: "name", value: name.toSkylark()), .named(name: "module_name", value: moduleName.toSkylark()),
        ...
        if let swiftHeader = self.swiftHeader { args.append(.named(name: "swift_hdr", value: swiftHeader.toSkylark())) }
        ...
        return SkylarkNode.functionCall(name: "gen_module_map", arguments: args)
    }
}
